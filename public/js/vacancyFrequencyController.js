...
controller('vacancyFrequencyController', ['$scope', '$rootScope', '$stateParams', 'Mensaje', 'Dictionary', 'vacancyService', '$state', 'keepData', '$filter', function ($scope, $rootScope, $stateParams, Mensaje, Dictionary, vacancyService, $state, keepData, $filter) {
    $scope.Dato = {};
    $scope.Dato.employer = '';
    $scope.Dato.job = '';
    $scope.Dato.vacancy = '';
